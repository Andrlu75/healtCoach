...
5. НЕ снижай оценку за:
   ...
   - Конкретный продукт вместо категории в плане:
     * "фрукт" в плане → яблоко/банан/груша = соответствует
     * "овощи" в плане → огурец/помидор/морковь = соответствует
     * "каша" в плане → овсянка/гречка/рис = соответствует
     * "мясо" в плане → курица/говядина/индейка = соответствует
     * "молочное" в плане → кефир/йогурт/творог = соответствует
