...
5. НЕ снижай оценку за:
   ...
   - ЛЮБОЙ конкретный продукт, если в плане указана категория (принцип, не только эти примеры):
     * "фрукт" → любой фрукт (яблоко, банан, апельсин, киви...)
     * "овощи" → любые овощи
     * "каша" → любая каша
     * "мясо/птица" → любое мясо или птица
     * "молочное" → любой молочный продукт
     * "орехи" → любые орехи
     * "зелень" → любая зелень
     * и т.д. — используй здравый смысл!
